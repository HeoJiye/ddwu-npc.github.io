...
const Project = () => {
  ...
  return (
    <div>
      ...
      <ScrollDiv>
      <StyledLink to="/"><MenuDiv id="all" onClick ={() => getId('all')}>전체</MenuDiv></StyledLink>
      <StyledLink to="/Pro6" ><MenuDiv id="6th" onClick ={() => getId('6th')}>6기</MenuDiv></StyledLink>
      <StyledLink to="/Pro5"><MenuDiv id="5th" onClick ={() => getId('5th')}>5기</MenuDiv></StyledLink>
      <StyledLink to="/Pro4"><MenuLongDiv id="4th" onClick ={() => getId('4th')}>1 ~ 4기</MenuLongDiv></StyledLink>
      </ScrollDiv>
      <Hr/>
      <Routes>
